...
extern "C" {
    #[doc = " Align a single paired-end sequences and generate the alignments in the SAM format"]
    #[doc = ""]
    #[doc = " This routine requires $seqs[i].{l_seq,seq,name} and write $seqs[i].sam."]
    #[doc = " Note that $seqs[i].sam may consist of several SAM lines if the"]
    #[doc = " corresponding sequence has multiple primary hits."]
    #[doc = ""]
    #[doc = " This assumes that MEM_F_PE is set in $opt->flag. seq[0] is read 1 and"]
    #[doc = " seqs[1] is read 2."]
    #[doc = ""]
    #[doc = " @param opt    alignment parameters"]
    #[doc = " @param bwt    FM-index of the reference sequence"]
    #[doc = " @param bns    Information of the reference"]
    #[doc = " @param pac    2-bit encoded reference"]
    #[doc = " @param seqs   query sequences; $seqs[i].seq/sam to be modified after the call"]
    #[doc = " @param pes0   insert-size info; Must be an array with 4 elements,"]
    #[doc = "               corresponding to each FF, FR, RF and RR orientation. See mem_pestat() for more info."]
